...
export type ClaimType = "HEALTH" | "MOTOR" | "REIMBURSEMENT" | "CASHLESS";
export type ClaimStatus =
    | "SUBMITTED" | "OCR_PROCESSED" | "UNDER_REVIEW" | "FRAUD_ANALYZED"
    | "APPROVED" | "PRE_AUTHORIZED" | "REJECTED" | "MANUAL_REVIEW_REQUIRED" | "SETTLED";
...
export interface NetworkClaimsResponse {
    items: NetworkClaimItem[];
    total: number;
}
